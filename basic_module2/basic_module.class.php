 ...
 */
class Basic_module extends ModuleObject
{
	/**
	...
	public function moduleInstall()
	{
		...
		$oModuleController = getController('module');
		debugPrint($oModuleController);
		$module_info = $oModuleModel->getModuleInfoByMid('basic_module');
		debugPrint($module_info);
		if ($module_info->module_srl)
		{
			if ($module_info->module != 'basic_module')
			{
		...
		{
			$args = new stdClass;
			$args->mid = 'basic_module';
			$args->module = 'basic_module';
			$args->browser_title = Context::getLang('cmd_basic_module');
			$args->site_srl = 0;
			$args->skin = 'default';
